...
def greet():
    ...
    if 0 <= hour < 12:
        speak("Good morning sir I am CIYA, a personal assistant created by Mr. Vaibhav Datta.")
    elif 12 <= hour < 18:
        speak("Good afternoon sir I am CIYA, a personal assistant created by Mr. Vaibhav Datta.")
    else:
        speak("Good evening sir I am CIYA, a personal assistant created by Mr. Vaibhav Datta.")

# Listenig & Recognizing
def takeCommand():
    r = sr.Recognizer()
# Very sensitive to low-volume speech
    r.energy_threshold = 100
# Allows longer phrases
...
# Exit Commands
        ...
        if any(phrase in command for phrase in ["sleep","go to sleep", "activate sleep mode", "ciya stop", "eva stop", "stop", "no", "bye", "ciya ruk ja", "eva ruk ja", "ruk ja", "exit", "ciya exit", "eva exit"]):
...
# Hi
            ...
            speak("Hello I am a personal assistant created by Mr. Vaibhav Datta, I can perform various tasks like google search, remembering info, opening your apps, tell you current time, remember what you say, store info under certain keywords and power off your system\nCurrently I don't have my own brain so I can only perform or follow commands that are intigrated in me\nSoon my developer will upgrade me and I will be having my own brain and thoughts and I can communicate with you more effectively and naturally! ")
...
# Google search
        ...
        elif any(phrase in command for phrase in ["google", "search", "search on google", "who is"]):
